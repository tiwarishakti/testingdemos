	...
	@Test(priority = 1)
	  public void register() throws InterruptedException {
		...
		Thread.sleep(5000);
	      ...
	      Thread.sleep(5000);
	      wd.findElement(By.id("ap_customer_name")).sendKeys("Shakti");
	      Thread.sleep(5000);
	      wd.findElement(By.id("ap_phone_number")).sendKeys("123456789");
	      Thread.sleep(5000);
	      wd.findElement(By.id("ap_email")).sendKeys("shaki@gmail.com");
	      Thread.sleep(5000);
	  ...
	  public void login() throws InterruptedException {
		 ...
		 wd.findElement(By.id("nav-link-accountList")).click();
		 Thread.sleep(5000);
	     wd.findElement(By.id("ap_email")).sendKeys("shakti@gmail.com");
	     Thread.sleep(5000);
		  wd.findElement(By.id("continue")).click();
		  Thread.sleep(5000);
	    // wd.findElement(By.id("ap_password")).sendKeys("12345678");
